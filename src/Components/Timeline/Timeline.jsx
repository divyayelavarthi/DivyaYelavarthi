  ...
  return (
    <div>
      {timelineElements.map((element) => {
        ...
        const color = defaultColor || `bg-red-500`;
        ...
        return (
          <div key={element.id} className="flex m-4 relative">
            ...
            <div className="border border-gray-600 rounded-lg px-12 py-12 w-full text-center z-10">
              ...
              <div className="flex flex-wrap mb-6 justify-center">
                {element.tech.map((tech, index) => {
                  return (
                    <span
                      key={index}
                      className="rounded-xl px-2 py-1 text-sm m-1"
                    >
                      {tech}
                    </span>
                  );
